...
const FlashMessage = () => {
  ...
  return (
    visible && (
      <div id="alert-1" className="flex col-span-12 h-[3.75rem] items-center p-4 text-blue-800 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400" role="alert">
